...
val Icons.SimilarImage: ImageVector
    get() {
        if (_SimilarImage != null) {
            return _SimilarImage!!
        }
        _SimilarImage = ImageVector.Builder(
            name = "SimilarImage",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _SimilarImage: ImageVector? = null
