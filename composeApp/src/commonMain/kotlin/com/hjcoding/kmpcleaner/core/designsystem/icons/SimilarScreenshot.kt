...
val Icons.SimilarScreenshot: ImageVector
    get() {
        if (_SimilarScreenshot != null) {
            return _SimilarScreenshot!!
        }
        _SimilarScreenshot = ImageVector.Builder(
            name = "SimilarScreenshot",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _SimilarScreenshot: ImageVector? = null
